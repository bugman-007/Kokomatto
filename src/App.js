    ...
    <Provider store={store}>
      <Router>
        <Routes>
          ...
          <Route
            path="/merchant/login"
            element={<MerchantLoginPage onLogin={handleLogin} />}
          />
          ...
          <Route
            ...
            element={<AffiliateLoginPage onLogin={handleLogin} />}
          />
          ...
          <Route element={<ProtectedRoute allowedRoles={["user"]} />}>
            ...
            <Route
              path="/categories"
              element={<CategoriesPage onLogout={handleLogout} />}
            />
          ...
          <Route element={<ProtectedRoute allowedRoles={["merchant"]} />}>
            <Route
              path="/merchants"
              element={<MerchantPortalPage onLogout={handleLogout} />}
            />
            <Route
          ...
          <Route element={<ProtectedRoute allowedRoles={["admin"]} />}>
            <Route
              path="/admin"
              element={<OwnerDashboardPage onLogout={handleLogout} />}
            />
            <Route
          ...
          <Route
            element={
              <ProtectedRoute allowedRoles={["affiliate", "merchant"]} />
            }
          >
          ...
          >
            <Route
              ...
              element={<AffiliateDashboardPage onLogout={handleLogout} />}
            />
            <Route
            ...
            />
            <Route
              path="/affiliate/dashboard/earnings"
              element={<AffiliateDashboardPage onLogout={handleLogout} />}
            />
            <Route
              path="/affiliate/dashboard/materials"
              element={<AffiliateDashboardPage onLogout={handleLogout} />}
            />
            <Route
              path="/affiliate/dashboard/social"
              element={<AffiliateDashboardPage onLogout={handleLogout} />}
            />
            <Route
            ...
            <Route
              ...
              element={<AffiliateDashboardSettingsPage />}
            />
            <Route
              path="/affiliate/dashboard/support"
              element={<AffiliateDashboardSupportPage />}
            />
          </Route>
